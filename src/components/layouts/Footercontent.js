...
//                                 <li> <Link to="#">Become our Agent</Link> </li>
//                                 <li> <Link to="#">Blog</Link> </li>
//                                 <li> <Link to="#">Complaint</Link> </li>
//                                 <li> <Link to="#">Forms</Link> </li>
//                                 <li> <Link to="#">Sell your property to us</Link> </li>
...
//                                 <li> <Link to="#">Find our agent worldwide</Link> </li>
        ...
        <div className="row">
          ...
          <div className="col-lg-2 offset-md-1 col-md-4 col-sm-6 footer-widget">
            ...
            <ul>
              ...
              <li>
                {" "}
                <Link to="#">Sell your property to us</Link>{" "}
              </li>
              <li>
                {" "}
